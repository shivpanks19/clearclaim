	...
	return (
		<>
			...
			<div className="cards xl:w-76 md:mb-20 flex flex-col items-center xl:flex-row md:justify-between mx-5 md:mx-auto">
				<div className="rounded flex flex-col items-center gap-3 shadow-md transition-all duration-100 hover:-translate-y-0.5 hover:shadow-lg md:w-96 pb-3.5 md:pb-10 px-5 mb-16 md:h-64">
				...
				<div className="rounded flex flex-col items-center gap-3 shadow-md transition-all duration-100 hover:-translate-y-0.5 hover:shadow-lg md:w-96 pb-3.5 md:pb-10 px-5 md:px-10 mb-16 md:h-64">
					<div className="relative w-20 h-20 md:w-32 md:h-32 -mt-10 md:-mt-12 self-center grow-0">
						<Image
				...
				<div className="rounded flex flex-col items-center gap-3 shadow-md transition-all duration-100 hover:-translate-y-0.5 hover:shadow-lg md:w-96 pb-3.5 md:pb-10 px-5 md:px-10 mb-11 md:mb-16 md:h-64">
					<div className="relative w-20 h-20 md:w-32 md:h-32 -mt-10 md:-mt-12 self-center grow-0">
						<Image
