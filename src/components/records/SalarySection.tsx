	...
	return (
		<>
			<SectionHeadline
				...
				className=' mx-5'
			/>
			<div className="xl:w-76 mx-auto relative mb-5 md:mb-20 md:pt-10 cardContainer md:w-42 md:grid-cols-2 lg:grid-cols-3 md:gap-9 px-5 grid place-items-center">
				<SalaryCard />
				<SalaryCard />
				<SalaryCard />
			</div>
