...
const SortBy = ({ categoryList , sortingOrder , setSortingOrder  })=>{
    return /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
        className: "container ml-2 md:ml-8 w-64 h-10",
...
const Events = ({ tapEventPageInfo , eventList , courseList  })=>{
    ...
    const [sortingOrder, setSortingOrder] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)("DESC");
    (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(()=>{
        router.push(_utils_routes__WEBPACK_IMPORTED_MODULE_9__/* ["default"].events */ .Z.events(undefined, q, sortingOrder), undefined, {
            scroll: false
        });
    }, [
        q,
                ...
                children: [
                    ...
                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_components_tap_events_SortBy__WEBPACK_IMPORTED_MODULE_8__/* ["default"] */ .Z, {
                        categoryList: [
                            {
                                id: "DESC",
                                title: "Descending: Date Published"
                            },
                            {
                                id: "ASC",
                                title: "Ascending: Date Published"
                            }
                        ],
...
function getTapEventList(_locale, populate, params, sortingOrder) {
    return (0,_services_serverConfig__WEBPACK_IMPORTED_MODULE_0__/* .get */ .U)(_services_serviceUrls__WEBPACK_IMPORTED_MODULE_1__/* ["default"].getTapEventList */ .Z.getTapEventList, {
        ...
        sort: [
            sortingOrder === "ASC" ? "eventName" : "eventName:desc"
        ]
    });
}
